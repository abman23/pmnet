...
class RadioWNet(nn.Module):
    ...
    def __init__(self,inputs=2,phase="firstU"):
        ...
        if inputs<=3:
            ...
            self.layer00 = convrelu(inputs, 18, 3, 1,1) 
            self.layer0 = convrelu(18, 40, 5, 2,2)
        else:
        ...
        if inputs<=3:
            ...
            self.conv_up00 = convrelu(20+18+inputs, 20, 5, 2,1)
    ...
    def forward(self, input):
        ...
        if self.phase=="firstU":
            # Freezing 2nd Unet and training 1st
            ...
            # Freezing 1st Unet and training 2nd
