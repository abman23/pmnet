...
from config.config_UCLA_pmnet_V1_TL_3 import config_UCLA_pmnet_V1_TL_3 as Config
...
def helper(cfg,writer,phase='train', data_root = 'C:/Users/ABMAN23_ML/Desktop/Joohan/UCLA/', model_to_eval=''):
    ...
    # data_root = 'C:/Users/ABMAN23_ML/Desktop/Joohan/UCLA/'
    ...
    if cfg.sampling == 'exclusive':
        ...
        data_ucla_train = PMnet_ucla(csv_file = os.path.join(data_root,'Data_coarse_train.csv'), dir_dataset=data_root)

        dataset_size = len(data_ucla_train)

        train_size = int(dataset_size * cfg.train_ratio)
        # validation_size = int(dataset_size * 0.1)
        test_size = dataset_size - train_size
        train_dataset, test_dataset = random_split(data_ucla_train, [train_size, test_size], generator=torch.Generator(device='cuda'))
